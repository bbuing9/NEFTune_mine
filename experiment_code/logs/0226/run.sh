...
CUDA_VISIBLE_DEVICES=0,1 python train_kd.py --init_checkpoint_path pretrained_models/Llama2_7b_sharded \
	--model_config_path pretrained_models/Llama2_7b_hf --wrapped_class_name LlamaDecoderLayer \
	--data_path datasets/alpaca-train.jsonl --prob_path checkpoints/full_prob --added_tokens 1 \
	--act_checkpointing --lr 5e-5 --accumulation_steps 16 --batch_size 4 \
	--checkpoint_path ./checkpoints/prev_kd0.1 --hack --self_kd 0.1  --wb_name prev_kd0.1

CUDA_VISIBLE_DEVICES=0,1 python train_kd.py --init_checkpoint_path pretrained_models/Llama2_7b_sharded \
	--model_config_path pretrained_models/Llama2_7b_hf --wrapped_class_name LlamaDecoderLayer \
	--data_path datasets/alpaca-train.jsonl --prob_path checkpoints/full_prob --added_tokens 1 \
	--act_checkpointing --lr 5e-5 --accumulation_steps 16 --batch_size 4 \
	--checkpoint_path ./checkpoints/prev_kd0.03 --hack --self_kd 0.03  --wb_name prev_kd0.03
...
CUDA_VISIBLE_DEVICES=0,1 python train_kd.py --init_checkpoint_path pretrained_models/Llama2_7b_sharded \
	...
	--data_path datasets/alpaca-train.jsonl --prob_path checkpoints/full_prob --added_tokens 1 \
	--act_checkpointing --lr 5e-5 --accumulation_steps 16 --batch_size 4 \
	--checkpoint_path ./checkpoints/prev_kd0.01 --hack --self_kd 0.01  --wb_name prev_kd0.01
